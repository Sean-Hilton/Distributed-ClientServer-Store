...
public class RemoveItemCommand extends UnicastRemoteObject implements Icommand{
	...
	public RemoveItemCommand() throws RemoteException
	{
		super();
	...
	public Idepartment execute() {
	  ...
	  try {
		d.removeItems(type, description);
